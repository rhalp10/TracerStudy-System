...
<!--     <style type="text/css">
    ...
    <script type="text/javascript">
     ...
     <div class="form-group">
        <a class="btn btn-primary" id="print-btn" ">Print</a>
        <a class="btn btn-primary" type="button" id="cmd" >Download</a>
    </div>
    </form>
    ...
    var config = {
        ...
        data: {
            ...
            datasets: [{
                data: [
                    parseInt(<?php echo $count_total_qa4_1_true?>),
                    parseInt(<?php echo $count_total_qa4_1_true?>),
                    parseInt(<?php echo $count_total_qa4_1_true?>),
                    parseInt(<?php echo $count_total_qa4_1_true?>),
                    parseInt(<?php echo $count_total_qa4_1_true?>),
                    parseInt(<?php echo $count_total_qa4_1_true?>),
                    parseInt(<?php echo $count_total_qa4_1_false?>),
                    parseInt(<?php echo $count_total_qa4_1_false?>),
                    parseInt(<?php echo $count_total_qa4_1_false?>),
                    parseInt(<?php echo $count_total_qa4_1_false?>),
                    parseInt(<?php echo $count_total_qa4_1_false?>),
