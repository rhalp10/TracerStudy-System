                            ...
                            <section class="panel">
                                ...
                                <div class="panel-body bio-graph-info">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="bio-row">
                                            <p><span>Address </span>: <?php echo $res_sidebar[$userType.'_address'];?>
                                            </p>
                                        </div>
                                        <div class="bio-row">
                                        ...
                                        <div class="bio-row">
                                            <p><span>Mobile </span>: <?php echo $res_sidebar[$userType.'_contact'];?>
                                            </p>
                                        </div>
                                        <?php 
                                                if ($userType == "student") {
                                                  ?>
                                        <div class="bio-row">
                                            <p><span>ID Number </span>:
                                                <?php echo $res_sidebar[$userType.'_IDNumber'];?></p>
                                        </div>
                                        <?php
                                        ...
                                        <div class="bio-row">
                                            <p><span>Admission Date </span>:
                                                <?php echo $res_sidebar[$userType.'_admission'];?></p>
                                        </div>
                                        <?php
                                                }
                                                ?>
...
INNER JOIN cvsu_course cc ON usd.student_department = cc.course_ID WHERE student_ID = $login_id");
                        ...
                        <div class="container">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" id="editModal" action="action/update.php"
                                                name="editModal">
                                                <div class="form-group">
                                                    <label class="control-label col-lg-4">Change Picture</label>
                                                    <div class="col-lg-4">
                                                        <a class="btn btn-default" data-toggle="modal"
                                                            data-target="#modal-changepic">Update Picture</a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <a class="btn btn-default" data-toggle="modal"
                                                            data-target="#modal-name">Update Name</a>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <a class="btn btn-default" data-toggle="modal"
                                                            data-target="#modal-gender">Update Gender</a>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <a class="btn btn-default" data-toggle="modal"
                                                            data-target="#modal-newpassword">Update Password</a>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <a class="btn btn-default" data-toggle="modal"
                                                            data-target="#modal-address">Update Address</a>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <a class="btn btn-default" data-toggle="modal"
                                                            data-target="#modal-cstatus">Update Status</a>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <a class="btn btn-default" data-toggle="modal"
                                                            data-target="#modal-bday">Update Birthday</a>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <a class="btn btn-default" data-toggle="modal"
                                                            data-target="#modal-contact">Update Contact</a>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <a class="btn btn-default" data-toggle="modal"
                                                            data-target="#modal-secretquestion">Update Secret
                                                            Question</a>
                                                    </div>
                            ...
                            <div class="modal fade" id="modal-changepic" data-modal-index="2">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form class="form" action="upload.php?login_id=<?php echo $login_id?>"
                                    ...
                                    <div class="modal-content">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input type="password" class="validate[required] form-control"
                                                            name="new_password" require value="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input type="password" class="validate[required] form-control"
                                                            name="new_repassword" require value="">
                                                    </div>
                                                </div>
                                                <!-- <div class="form-group">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-default"
                                                data-dismiss="modal">Close</button>
                                            <!-- <button type="button" class="btn btn-primary">Save changes</button> -->
                                            <input type="Submit" class="btn btn-primary" name="update_password"
                                                            value="Submit">
                                        </div>
                                            </form>
                                    </div><!-- /.modal-content -->
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <input type="Submit" class="btn btn-primary"
                                                            name="update_squestion" value="Submit">
                                        </div>
                                            </form>
                                    </div><!-- /.modal-content -->
                                </div><!-- /.modal-dialog -->
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input type="text" class="validate[required] form-control"
                                                            name="new_contact" require
                                                            value="<?php echo $res_sidebar[$userType.'_contact'];?>"
                                                            maxlength="11" onkeyup="numberInputOnly(this);">
                                                    </div>
                                                </div>
                                                <!-- <div class="form-group">
                                                    <label class="control-label col-lg-4"></label>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <input type="Submit" class="btn btn-primary"
                                                            name="update_contact" value="Submit">
                                        </div>
                                            </form>
                                    </div><!-- /.modal-content -->
                                </div><!-- /.modal-dialog -->
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input type="date" class="validate[required] form-control"
                                                            name="new_bday" require
                                                            value="<?php echo isset($res_sidebar[$userType.'_dob']) ? $newDate = date("Y-m-d", strtotime($res_sidebar[$userType.'_dob'])) : ''?>">
                                                    </div>
                                                </div>
                                                <!-- <div class="form-group">
                                                    <label class="control-label col-lg-4"></label>
                                                    <div class="col-lg-4">
                                                        <input type="Submit" class="btn btn-primary" name="update_bday"
                                                            value="Submit">
                                                    </div>
                                                </div> -->
                                        </div>
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" id="update_address" method="POST"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input type="Submit" class="btn btn-primary"
                                                            name="update_address" value="Submit">
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                          ...
                          while ($mstat = mysqli_fetch_array($mstat_q)) {
                             ?>
                                                            <option value="<?php echo $mstat['id']; ?>">
                                                                <?php echo $mstat['marital_Name']; ?></option>
                                                            <?php
                          }
                          ?>
                                                        </select>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <!-- <button type="button" class="btn btn-primary">Save changes</button> -->
                                                        <input type="Submit" class="btn btn-primary"
                                                            name="update_cstatus" value="Submit">
                                        </div>
                                            </form>
                                    </div><!-- /.modal-content -->
                                </div><!-- /.modal-dialog -->
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <!-- <button type="button" class="btn btn-primary">Save changes</button> -->
                                            <input type="Submit" class="btn btn-primary"
                                                            name="update_gender" value="Submit">
                                        </div>
                                            </form>
                                    </div><!-- /.modal-content -->
                                </div><!-- /.modal-dialog -->
