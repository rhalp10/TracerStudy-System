...
$sql.=" FROM `user_student_detail` year_grad  WHERE student_department = 'IT' ORDER BY student_year_grad Asc";
$query=mysqli_query($con, $sql) or die("serverside_data_IT_Alumni.php: get employees");
