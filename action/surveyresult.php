...
if (isset($_POST['submit-survey'])) {
    ...
    else
    {
	 ...
	 // 	$Communication_skills =  stripslashes($Communication_skills);
		...
		// $pre_stat = mysqli_real_escape_string($con,$pre_emp);
	 // 	$Communication_skills =  mysqli_real_escape_string($con,$Communication_skills);
		...
		// $q4_sql = "INSERT INTO survey_question4 (`survey_qID`, `row1`, `col1`) ";
		// $q4_sql.= "VALUES (NULL, '1', '$Below5k')";
		// mysqli_query($con,$q4_sql);
		// $q4_sql = "INSERT INTO survey_question4 (`survey_qID`, `row1`, `col1`) ";
		// $q4_sql.= "VALUES (NULL, '2', '$k5lessthan10k')";
		// mysqli_query($con,$q4_sql);
		// $q4_sql = "INSERT INTO survey_question4 (`survey_qID`, `row1`, `col1`) ";
		// $q4_sql.= "VALUES (NULL, '3', '$k10lessthan15k')";
		// mysqli_query($con,$q4_sql);
		// $q4_sql = "INSERT INTO survey_question4 (`survey_qID`, `row1`, `col1`) ";
		// $q4_sql.= "VALUES (NULL, '4', '$k15lessthan20k')";
		// mysqli_query($con,$q4_sql);
		// $q4_sql = "INSERT INTO survey_question4 (`survey_qID`, `row1`, `col1`) ";
		// $q4_sql.= "VALUES (NULL, '5', '$k20lessthan25k')";
		// mysqli_query($con,$q4_sql);
		// $q4_sql = "INSERT INTO survey_question4 (`survey_qID`, `row1`, `col1`) ";
		// $q4_sql.= "VALUES (NULL, '6', '$k25andabove')";
		// mysqli_query($con,$q4_sql);
		// $q5_sql = "INSERT INTO survey_question5 (`survey_qID`, `ans`) ";
		// $q5_sql.= "VALUES (NULL, '$pre_emp')";
		// mysqli_query($con,$q5_sql);
		// $q5_sql = "INSERT INTO survey_question6 (`survey_qID`, `ans`) ";
		// $q5_sql.= "VALUES (NULL, '$pre_emp')";
		// mysqli_query($con,$q5_sql);
